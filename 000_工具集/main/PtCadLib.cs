...
namespace main
{
    public class PtCadLib
    {
        ...
        /// 创建一个线性标注
        /// </summary>
        /// <param name="xLinePt1">标注点1</param>
        /// <param name="xLinePt2">标注点2</param>
        /// <param name="rotation">角度</param>
        /// <param name="dimLinePoint">标注线长</param>
        public void CreatRotatedDimension(Point3d xLinePt1, Point3d xLinePt2, double rotation, Point3d dimLinePoint)
        {
            Database acCurDb = acDoc.Database;
            using(Transaction acTrans = acDoc.TransactionManager.StartTransaction())
            {
                ...
                acRotDim.XLine1Point = xLinePt1;
                acRotDim.XLine2Point = xLinePt2;
                acRotDim.Rotation = rotation;
                acRotDim.DimLinePoint = dimLinePoint;

                acBlkTb1Rec.AppendEntity(acRotDim);
